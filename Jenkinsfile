pipeline {
  ...
  environment {
    ...
    BUILD_VERSION_ARG = 'WEIXIN_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-weixin'
    CONTAINER_NAME = 'weixin'
    DOCKERHUB_IMAGE = 'linuxserver/weixin'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/weixin'
    PR_DOCKERHUB_IMAGE = 'lspipepr/weixin'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-weixin/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-weixin\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-weixin\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Weixin\" \
          --label \"org.opencontainers.image.description=[Weixin](https://weixin.qq.com/) (WeChat) is an instant messaging, social media, and mobile payment app developed by Tencent.\" \
